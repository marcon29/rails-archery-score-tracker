...
def valid_category_alt
  Organization::ArcherCategory.find_or_create_by(cat_code: "US-CJW", gov_body: valid_gov_body_alt, division: valid_division_alt, age_class: valid_age_class_alt, gender: valid_gender_alt)
end
